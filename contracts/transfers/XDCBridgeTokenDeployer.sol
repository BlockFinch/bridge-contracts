    ...
    IXDCBridgeTokenDeployer
{
    ...
    /// @dev Maps xbridge id to deBridgeToken address
        ...
        returns (address deBridgeTokenAddress)
    {
        ...
        assembly {
            // xbridgeId is a salt
            deBridgeTokenAddress := create2(0, add(bytecode, 0x20), mload(bytecode), _xbridgeId)
        ...
        getDeployedAssetAddress[_xbridgeId] = deBridgeTokenAddress;
    ...
    function setXDCBridgeTokenAdmin(address _deBridgeTokenAdmin) external onlyAdmin {
